...
public class ListTTFragment extends AbsBaseFragment{
    ...
    public static ListTTFragment newInstance() {
        Bundle args = new Bundle();

        ListTTFragment fragment = new ListTTFragment();
    ...
    protected int getLayout() {
        return R.layout.fra_list_tt;
    }

    @Override
    protected void initView() {
        left=bindView(R.id.buttons_left_dislike);
        right=bindView(R.id.buttons_right_like);
    }
    ...
    protected void initDatas() {
        ...
        adapter = new CardAdapter(context, al);
        flingContainer = bindView(R.id.fra_list_tt_swipefilingadapterview);
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                makeToast(context, "不喜欢");
            }

            @Override
            public void onRightCardExit(Object dataObject) {
                makeToast(context, "喜欢");
            }
